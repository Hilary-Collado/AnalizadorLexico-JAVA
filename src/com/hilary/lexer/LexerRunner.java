...
//        open.addActionListener(this::onOpen);
//
//        JButton analyze = new JButton("Analizar");
//        analyze.addActionListener(this::onAnalyze);
//
//        JButton exportCsv = new JButton("Exportar tokens (CSV)");
//        exportCsv.addActionListener(this::onExportCsv);
//
//        JButton demo = new JButton("Cargar demo");
//        demo.addActionListener(e -> loadDemo());
//
//        bar.add(open);
//        bar.add(analyze);
...
//    }
//
//    /** Botón con estilo sólido y texto blanco */
//    private JButton solidButton(String text, Color bg) {
